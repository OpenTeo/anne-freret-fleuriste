          ...
          {'isGraphic' in slide && slide.isGraphic ? (
            ...
            <>
              ...
              <div className="absolute bottom-0 left-0 right-0">
                {/* Trust bar avis */}
                <div className="flex items-center justify-center gap-2 py-2 bg-[#faf8f5]/80 backdrop-blur-sm border-b border-[#e8e0d8]/30">
                  <span className="text-[9px] md:text-[10px] text-[#2d2a26]/40">4.8 / 5</span>
                  <div className="flex">
                    {[1,2,3,4,5].map(s => (
                  ...
                  <span className="text-[9px] md:text-[10px] text-[#2d2a26]/40 uppercase tracking-wider">238 avis clients</span>
                </div>
