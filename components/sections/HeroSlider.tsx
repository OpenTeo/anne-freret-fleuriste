...
const slides = [
  {
    ...
    image: '/images/bouquets/saint-pairais.png',
          ...
          {'isGraphic' in slide && slide.isGraphic ? (
            <div className="w-full h-full relative flex items-center justify-center px-5 md:px-16">
              ...
              <div className={`relative z-10 max-w-4xl w-full text-center transition-all duration-700 ${i === current ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                <p className="text-[#b8935a] text-[10px] md:text-[11px] tracking-[0.3em] uppercase mb-3 md:mb-4">Nouveau</p>
                ...
                <div className="grid grid-cols-3 gap-2.5 md:gap-5 max-w-2xl mx-auto mb-6 md:mb-8">
                  <div className="border border-[#e8e0d8] p-3 md:p-5 bg-white">
                    <p className="text-[9px] md:text-[10px] tracking-[0.2em] uppercase text-[#b8935a] mb-1.5">Essentiel</p>
                  ...
                  <div className="border-2 border-[#b8935a] p-3 md:p-5 bg-white relative">
                    <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-[#b8935a] text-white text-[7px] md:text-[9px] tracking-[0.15em] uppercase px-2.5 py-0.5">Populaire</div>
                    <p className="text-[9px] md:text-[10px] tracking-[0.2em] uppercase text-[#b8935a] mb-1.5">Signature</p>
                    <p className="font-serif text-xl md:text-3xl text-[#2d2a26]">49<span className="text-sm md:text-xl">.90€</span></p>
                    <p className="text-[#2d2a26]/30 text-[9px] md:text-[10px] mt-0.5 mb-2">/mois</p>
                    <div className="border-t border-[#b8935a]/20 pt-2 space-y-1">
                  ...
                  <div className="border border-[#e8e0d8] p-3 md:p-5 bg-white">
                    <p className="text-[9px] md:text-[10px] tracking-[0.2em] uppercase text-[#b8935a] mb-1.5">Prestige</p>
                ...
                <span className="inline-block text-[#2d2a26] text-sm tracking-wide underline underline-offset-8 decoration-[#b8935a]">
              ...
              <div className="absolute bottom-0 left-0 right-0">
                <div className="bg-white/90 backdrop-blur-sm p-5 md:p-8 pb-12 md:pb-14">
                  <div className="max-w-4xl">
                    <p className={`text-[#b8935a] text-[11px] md:text-xs tracking-[0.25em] uppercase mb-2 md:mb-3 transition-all duration-700 delay-100 ${i === current ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                      {slide.subtitle}
                    </p>
                    ...
                    <span className={`inline-block text-[#2d2a26] text-sm tracking-wide underline underline-offset-8 decoration-[#b8935a] hover:text-[#b8935a] transition-all duration-500 delay-300 ${i === current ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                      {slide.cta}
                    </span>
                  </div>
                </div>
