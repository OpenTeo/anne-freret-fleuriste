        ...
        {!submitted ? (
          <>
            <div className="text-center mb-6">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#b8935a]/10 rounded-full flex items-center justify-center">
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] text-[#b8935a] mb-3">Offre de bienvenue</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <input
                ...
                required
                className="w-full px-4 py-3 bg-white border border-[#e8e0d8] text-[#2d2a26] text-sm placeholder:text-[#2d2a26]/30 focus:outline-none focus:border-[#b8935a] transition-colors"
              />
              <button
                type="submit"
                className="w-full bg-[#b8935a] text-white py-3 text-sm uppercase tracking-[0.15em] hover:bg-[#b8956a] transition-colors"
              >
          ...
          <div className="text-center py-4">
            ...
            <p className="text-sm text-[#2d2a26]/60">
              Votre code <span className="font-medium text-[#b8935a]">BIENVENUE10</span> arrive dans votre boîte mail.
            </p>
          </div>
        )}
      </div>
