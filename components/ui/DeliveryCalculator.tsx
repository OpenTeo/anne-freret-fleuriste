      ...
      <div className="relative">
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2.5 border border-[#e8e0d8] bg-white text-base text-[#2d2a26] font-light placeholder:text-[#2d2a26]/25 focus:outline-none focus:border-[#b8935a] transition-colors"
          />
        </div>
            ...
            {suggestions.map((zone, index) => (
              <button
                ...
                className={`w-full px-3 py-2.5 text-left transition-colors border-b border-[#e8e0d8]/30 last:border-0 ${
                  index === selectedIndex ? 'bg-[#b8935a]/5' : 'hover:bg-[#faf8f5]'
                }`}
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-xs text-[#b8935a] ml-2 font-medium">{zone.deliveryFee}€</span>
                  </div>
                </div>
              </button>
            ))}
