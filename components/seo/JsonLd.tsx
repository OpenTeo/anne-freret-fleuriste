    ...
    switch (type) {
      case 'LocalBusiness':
        return {
          ...
          description:
            'Artisan fleuriste depuis 2001 à Saint-Pair-sur-Mer. Bouquets artisanaux, mariages, deuil, abonnements. Livraison en Normandie et France entière.',
          ...
          areaServed: [
            ...
            { '@type': 'State', name: 'Manche' },
            { '@type': 'State', name: 'Ille-et-Vilaine' },
      ...
      case 'Organization':
        return {
          ...
          logo: 'https://fleuriste-annefreret.com/images/logo.png',
          description:
            'Artisan fleuriste depuis 2001 à Saint-Pair-sur-Mer, Normandie. Bouquets artisanaux, mariages, deuil, livraison France.',
          address: {
            '@type': 'PostalAddress',
            addressLocality: 'Saint-Pair-sur-Mer',
            addressRegion: 'Normandie',
