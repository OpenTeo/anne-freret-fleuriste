        ...
        <section className="py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <div className="mb-12 md:mb-16">
              <p className="text-[#b8935a] text-[10px] tracking-[0.3em] uppercase mb-3">Mon espace</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              {menuItems.map((item) => (
                <button
                  ...
                  className="flex items-start gap-4 p-6 bg-white border border-[#e8e0d8] hover:border-[#b8935a] transition-all duration-300 text-left group"
                >
                  <span className="flex-shrink-0">{item.icon}</span>
                  <div>
                    <p className="text-[#2d2a26] text-sm font-medium group-hover:text-[#b8935a] transition-colors">{item.label}</p>
            ...
            <div className="text-center">
              <button
                ...
                className="text-sm text-[#2d2a26]/40 hover:text-[#b8935a] underline underline-offset-4 transition-colors"
              >
                Se déconnecter
              </button>
            </div>
