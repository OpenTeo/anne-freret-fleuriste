      ...
      <main className="bg-[#faf8f5] min-h-screen pt-20">
        ...
        <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6">
            <div className="bg-white/80 backdrop-blur-sm px-8 py-8 md:px-14 md:py-12 text-center max-w-xl border border-white/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative aspect-[3/4] lg:aspect-[4/5] overflow-hidden">
                <Image
                  ...
                  alt="Charles en train de composer un centre de table de mariage"
                  fill
                  className="object-cover"
                />
              </div>
