    ...
    <main className="bg-[#faf8f5] pt-28 md:pt-32">
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-6 mb-8">
        <div className="flex items-center gap-3 bg-white border border-[#e8e0d8] p-4">
          <svg className="w-5 h-5 text-[#b8935a] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <aside className="md:w-48 flex-shrink-0">
              ...
              {categories.map(cat => (
                <button
                  ...
                  className={`whitespace-nowrap text-left text-xs md:text-[11px] uppercase tracking-[0.15em] px-3 py-2 md:px-0 md:py-2.5 md:border-b border-[#e8e0d8]/50 transition-all duration-300 ${
                    activeFilter === cat.id 
                      ? 'text-[#b8935a] md:border-[#b8935a] bg-[#b8935a]/5 md:bg-transparent' 
            ...
            <div className="hidden md:block mt-8 pt-6 border-t border-[#e8e0d8]/50">
              <p className="text-[9px] uppercase tracking-[0.2em] text-[#b8935a] mb-2">Conseil</p>
              <a href="tel:0233502615" className="text-sm text-[#2d2a26]/60 hover:text-[#b8935a] transition-colors">
                02 33 50 26 15
              </a>
                ...
                <Link key={product.slug} href={`/produit/${product.slug}`} className="group">
                  ...
                  {product.rating && (
                    <div className="flex items-center gap-1 mb-1.5">
                      <div className="flex">
                        {[1,2,3,4,5].map(s => (
                          <svg key={s} className={`w-3 h-3 ${s <= Math.round(product.rating!) ? 'text-[#b8935a]' : 'text-[#e8e0d8]'}`} fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-6 grid grid-cols-3 gap-4 md:gap-6 text-center">
          <div>
            <div className="w-10 h-10 mx-auto mb-3 rounded-full border border-[#b8935a]/30 flex items-center justify-center">
              <svg className="w-5 h-5 text-[#b8935a]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="bg-[#2d2a26] py-10 md:py-14">
        <div className="max-w-3xl mx-auto px-4 md:px-6 text-center">
          <p className="text-[#b8935a] text-[10px] tracking-[0.25em] uppercase mb-3">Nous sommes là pour vous</p>
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="tel:0233502615" className="flex items-center gap-2 text-white text-sm hover:text-[#b8935a] transition-colors">
            ...
            <Link href="/contact" className="text-white text-sm underline underline-offset-4 decoration-[#b8935a] hover:text-[#b8935a] transition-colors">
              Nous contacter
            </Link>
          </div>
        </div>
